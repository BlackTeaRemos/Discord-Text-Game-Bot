...
export interface CreateUserOptions {
    ...
    imageUrl?: string;
    /** Optional preferred locale such as en or ru to persist on the user node */
 ...
 * @returns Promise of CreatedUser Persisted user snapshot @example const user = await CreateUser({ discordId: '123' })
 */
