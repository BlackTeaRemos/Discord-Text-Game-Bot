 ...
 * @property BuildControlsContent Function Generates control content string @example renderers.BuildControlsContent(state)
 * @property RenderPreview Function Renders or updates the preview embed @example await renderers.RenderPreview(ctx)
 * @property RenderControls Function Renders or updates the control panel @example await renderers.RenderControls(ctx, 'Ready')
 */
 ...
 * @returns GameCreateRenderers Renderer callbacks provided during flow initialization
 */
