 ...
 * @property payload Record Stored JSON payload @example { currentTurn: 1 }
 */
 ...
 * @param options.payload Record JSON payload to store alongside the game @example { currentTurn: 1 }
 * @returns GameVariableResult Stored payload echo with the game uid
 * @example
